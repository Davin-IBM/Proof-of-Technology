...
Establish a connection to dashDB.  You'll need to fill in details of your dashDB instance in the connection.R file (if you haven't done so already).
...
vetting.table = 'DASH6815.FEMALE_TRAFFICKING'
